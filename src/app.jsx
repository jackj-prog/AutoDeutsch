...
class RootErrorBoundary extends React.Component {
  ...
  resetSessionAndReload = () => {
    try { localStorage.removeItem("gfc-last-v7"); } catch (e) {}
    window.location.reload();
  };
    ...
    <div style={{ fontFamily: BD, background: BG, color: T, minHeight: "100vh", maxWidth: 480, margin: "0 auto", position: "relative" }}>
      ...
      {screen === "home" && <div style={{ padding: "12px 20px 24px" }}>
        ...
        <div style={{ background: SOFT_PANEL, border: `1px solid ${B}`, borderRadius: 14, padding: "24px 22px 20px", marginBottom: 16, position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", top: 0, left: 22, width: 86, height: 3, background: FLAG, borderRadius: "0 0 2px 2px" }} />
          ...
          {resolvedDue.total > 0 ? (
            <button type="button" onClick={startDueReview}
              ...
              <span style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
                <IconBadge name="target" size={36} color="#0A0A0A" bg="#0A0A0A18" />
                <span>
                  <span style={{ display: "block", fontSize: 10, letterSpacing: 2, textTransform: "uppercase", opacity: 0.72 }}>Today's Review</span>
                  <span style={{ display: "block", fontFamily: FN, fontSize: 16, marginTop: 2 }}>{resolvedDue.total} card{resolvedDue.total !== 1 ? "s" : ""} due</span>
                  <span style={{ display: "block", fontSize: 10, fontWeight: 600, opacity: 0.65, marginTop: 2 }}>
            ...
            <button type="button" onClick={() => openSetup("__all__", setupMode)}
              ...
              <span style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <span>
                  <span style={{ display: "block", fontSize: 10, letterSpacing: 2, textTransform: "uppercase", opacity: 0.72 }}>Start Practice</span>
          ...
          <div style={{ display: "grid", gridTemplateColumns: lastSession ? "1fr 1fr" : "1fr", gap: 10 }}>
            {lastSession && <button type="button" onClick={() => lastSession.cat === "__due__" ? startDueReview() : startSession(lastSession.cat, lastSession.m, lastSession.count)}
              ...
              <span style={{ minWidth: 0 }}>
                <span style={{ display: "block", color: A, fontSize: 9, letterSpacing: 1.8, textTransform: "uppercase", fontWeight: 800 }}>Continue</span>
            ...
            <button type="button" onClick={() => openSetup("__all__", setupMode)}
              ...
              <span>
                <span style={{ display: "block", color: TD, fontSize: 9, letterSpacing: 1.8, textTransform: "uppercase", fontWeight: 800 }}>All Cards</span>
        ...
        <div style={{ background: SH, border: `1px solid ${B}`, borderRadius: 14, padding: "14px 16px", marginBottom: 20, position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", top: 0, left: 16, width: 62, height: 3, background: FLAG, opacity: 0.55, borderRadius: "0 0 2px 2px" }} />
        ...
        <div style={{ marginTop: 32, background: SH, border: `1px solid ${B}`, borderRadius: 14, padding: "22px 12px 14px", position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", top: 0, left: 12, width: 72, height: 3, background: FLAG, opacity: 0.75, borderRadius: "0 0 2px 2px" }} />
        ...
        {resolvedWeak.total > 0 && <>
          ...
          <button onClick={startWeakReview}
            ...
            <IconBadge name="target" size={32} color={R} />
            ...
            <Icon name="arrowRight" size={16} style={{ color: TD, opacity: 0.65 }} />
          </button>
        </>}
      </div>}
