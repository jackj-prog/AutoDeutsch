...
// The icon system (ICONS, SOLID_ICONS, Icon, IconBadge, ProgressIcon, ICO_* + playIconTap) now lives
// in src/components/icons.jsx — concatenated before this file (after src/lib). See docs/MODULARIZATION-PLAN.md.
          ...
          <div style={{ padding: "0 18px 14px", overflowY: "auto" }}>
            ...
            {setupCat === "__listening__" && (
              <div style={{ marginBottom: 16 }}>
                ...
                {listenMode === "questions" && <p style={{ fontSize: 10, color: TD, marginTop: 8, lineHeight: 1.4 }}>Only dialogues with questions will be included ({DIALOGUES.filter(d => d.questions && d.questions.length).length} available).</p>}
              </div>
            )}
